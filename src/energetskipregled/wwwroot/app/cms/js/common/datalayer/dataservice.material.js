(function () {
	...
	var serviceId = 'dataservice.material';

	angular.module('common').factory(serviceId, ['$resource', 'routeResolver', MaterialService]);

	function MaterialService($resource, routeResolver) {
		var getList = $resource(routeResolver.getApiUrl('Material/ListAll/'));
