(function () {
	...
	var serviceId = 'dataservice.project';

	angular.module('common').factory(serviceId, ['$resource', 'routeResolver', ProjectService]);

	function ProjectService($resource, routeResolver) {
		var getList = $resource(routeResolver.getApiUrl('Project/ListAll/'));
