(function () {
	...
	var serviceId = 'dataservice.tbeMaterial';

	angular.module('common').factory(serviceId, ['$resource', 'routeResolver', TBEMaterialService]);

	function TBEMaterialService($resource, routeResolver) {
		var getList = $resource(routeResolver.getApiUrl('TBEMaterial/ListAll/'));
