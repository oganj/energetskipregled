(function () {
	...
	var serviceId = 'dataservice.tbeHeatCorrectionFactor';

	angular.module('common').factory(serviceId, ['$resource', 'routeResolver', TBEHeatCorrectionFactorService]);

	function TBEHeatCorrectionFactorService($resource, routeResolver) {
		var getList = $resource(routeResolver.getApiUrl('TBEHeatCorrectionFactor/ListAll/'));
