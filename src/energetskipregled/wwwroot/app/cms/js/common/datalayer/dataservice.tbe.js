(function () {
	...
	var serviceId = 'dataservice.tbe';

	angular.module('common').factory(serviceId, ['$resource', 'routeResolver', TBEService]);

	function TBEService($resource, routeResolver) {
		var getList = $resource(routeResolver.getApiUrl('TBE/ListAll/'));
