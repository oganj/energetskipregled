(function () {
	...
	var serviceId = 'dataservice.tbeFrame';

	angular.module('common').factory(serviceId, ['$resource', 'routeResolver', TBEFrameService]);

	function TBEFrameService($resource, routeResolver) {
		var getList = $resource(routeResolver.getApiUrl('TBEFrame/ListAll/'));
