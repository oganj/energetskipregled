(function () {
	...
	playerController.$inject = ['$scope', 'dataservice', '$log', '$location', '$mdDialog', '$mdSimpleToast', '$rootScope'];
	function playerController($scope, dataservice, $log, $location, $mdDialog, $mdSimpleToast, $rootScope) {
		var vm = this;
		vm.players = [];
		...
		//vm.commandDevice = function (deviceSerialNumber, ev) {
		//	$mdDialog.show({
		//		controller: 'commandDeviceController as vm',
		//		templateUrl: 'app/cms/views/device/command.html',
		//		parent: angular.element(document.body),
		//		targetEvent: ev,
		//		locals: {
		...
		//	.then(function (answer) {
		//		if (answer) {
		//			$mdSimpleToast.show('Command succesful!');
		//			//init();
		//		} else {
		//			$mdSimpleToast.show('Command failed!');
		//		}
		//	}, function () {
		//	});
		//};
